---
description: "Browser-based ONNX inference with ONNX Runtime Web. Use when implementing privacy-first, low-latency, or offline ML (image classification, object detection, NLP) without server-side processing."
---
